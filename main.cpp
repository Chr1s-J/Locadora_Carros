    ...
    do
    {
        ...
        switch (opcao)
        {
                        ...
                        case 2:
                        {
                            ...
                            if (clienteAutenticado)
                            {
                                ...
                                do
                                {
                                    ...
                                    std::cout << "4. Estimativa de preco" << std::endl;
                                    std::cout << "5. Fazer uma reserva" << std::endl;                                
                                    std::cout << "6. Alterar senha" << std::endl;
                                    std::cout << "0. Voltar para a página inicial" << std::endl;
                                    std::cout << "==================================" << std::endl;
                                    std::cout << "Opção: ";
                                        ...
                                        case 4: //Ver preco
                                        {
                                            ...
                                            for (const auto& carro : locadora.carros)
                                            {
                                                if (carro.modelo == modelo && carro.disponivel)
                                                {
                                                    ...
                                                    numeroCartao = cliente.getCarteiraPagamento();  
                                                    break;
                                                }
                                            }
            ...
            case 2: //Menu do ADM
            {
                ...
                if (Admin::isMasterAdmin(user, senha)) 
                {
                    do 
                    {
                        ...
                        switch (opcaoAdmin) {
                            ...
                            case 5: // Cadastrar cliente
                            {
                                ...
                                // Add o cliente ao vetor clientes
                                cliente.clientes.push_back(novoCliente);
                            ...
                            case 0: // Voltar para a página inicial
                            {
                                std::cout << "Voltando para a página inicial..." << std::endl;
                                break;
                            }
                ...
                {
                    std::cout << "Usuário ou senha incorretos. Acesso negado." << std::endl;
                }
            }
